...
export class KEY  {
    ...
    private static New(scope: cdk.Stack, id: string, spec:kms.KeySpec): KEY {
    ...
    public static NewForDomain(scope: cdk.Stack, id: string): KEY {
        return KEY.New(scope, id, kms.KeySpec.RSA_2048);
    }

    public static NewForDnsSec(scope: cdk.Stack, id: string): KEY {
